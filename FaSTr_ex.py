...
data_file_path = os.path.join( dir, 'FaSTr_ex.csv')							# EDIT THIS NAME DEPENDING ON CSV FILE NAME
doc = pipeflo().doc()
...
while col <= 8:
	...
	with open( data_file_path ) as csvfile:
		...
		for data_col in reader:
			...
			flow_value = data_col[col] 															#EDIT THIS VALUE DEPENDING ON WHAT COLUMN THE DEMANDS ARE IN
		...
		col += 1
		if col == 4: lineup = "Connected Average"
		elif col == 5: lineup = "Committed Peak"
		elif col == 6: lineup = "Committed Average"
		elif col == 7: lineup = "Pending Peak"
		elif col == 8: lineup = "Pending Average"
